...
module.exports = { captchaStore, postRateLimit, qrCodeStore, redeemRateLimit, cardCreateLimits, onlineUsers, loginFailures, LOGIN_WINDOW_MS, LOGIN_MAX_FAILS, captchaGrantLimit, CAPTCHA_GRANT_WINDOW_MS, CAPTCHA_GRANT_MAX };
