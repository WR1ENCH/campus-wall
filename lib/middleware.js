...
function inputSanitize(req, res, next) {
  if (req.body && typeof req.body === 'object') {
    const { avatar, manualImages, manualEmail, images, content, title, text, body, reason, answer, question, description, options, password, zhixuePassword, oldPwd, newPwd, adminPassword, newPassword, confirmPassword, oldPassword, plan, payment, cardCode, duration, domain, ...rest } = req.body;
    req.body = {
      ...sanitizeString(rest),
